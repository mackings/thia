          ...
          child: Container(
            child: Column(
              children: [
                ...
                Center(
                  child: Text('Hello Thiago Admins', style: GoogleFonts.montserrat(
                    textStyle: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                ...
                Center(
                  child: Text('Kindly Aunthenticate Your  ID', style: GoogleFonts.montserrat(
                    textStyle: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                ...
                Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('Authenticate', style: GoogleFonts.montserrat(
                      textStyle: TextStyle(
                        color: Colors.white,
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
